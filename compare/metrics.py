...
METRIC_DESCRIPTORS: List[Tuple[str, str, str]] = [
    ...
    ("Data error",
     "Data error",
     "QEC data-block logical error contribution (Qualtran only; populated when optimize_factory=True or sweep path)"),
    ("Rotation synthesis error",
     "Rotation synthesis error",
     "Rotation synthesis error contribution to total error budget (Qualtran only)"),
    ("Factory error",
     "Factory error",
     "Magic-state factory distillation error contribution (Qualtran only)"),
    ("Code distance",
     "Code distance",
    ...
    ("Factory tuple",
     "Factory tuple",
     "FifteenToOne factory dimensions (d_X, d_Z, d_m) selected by the Qualtran optimizer (Qualtran only; None when optimize_factory=False)"),
    ("Factory config",
     "Factory config",
